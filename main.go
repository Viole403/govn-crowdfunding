...
func main() {
	...
	authService := auth.NewService() // Update to use the correct service
	...
	api.GET("/campaigns/:id/transactions", authMiddleware(authService, userService), transactionHandler.GetCampaignsTransaction)
